# Carta de Entendimiento — Prueba Demostrativa de Software
...
- Registro de ventas por peso o unidad
- Cálculo automático en dólares (USD) y bolívares (Bs)
- Gestión de tasa de cambio BCV
- Soporte para pagos mixtos (efectivo, pago móvil, punto, divisas)
- Emisión de tickets de venta

**Reportes y consultas:**
- Reportes de ventas por fecha con exportación a PDF
...
| | |
|---|---|
| **Por el Desarrollador** | **Por el Evaluador** |
| | |
| | |
...
| | |
| C.I./RIF: ______________________ | C.I./RIF: ______________________ |
| | |
| Correo: ______________________ | Correo: ______________________ |
| | |
| Teléfono: ______________________ | Teléfono: ______________________ |
| | |
...
**Fecha de firma:** _____ de _______________ de ________
